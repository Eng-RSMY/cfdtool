...
% =================================================
% 
% ![CFDTool Screenshot](cfdtool-screenshot.png)
% 
% 
% About
% -----
...
% 
% - For MATLAB 2009b-2012a, copy the **cfdtool.p** file to a
...
% ("we", "us", "ours"), a duly registered company in whose registered
...
% the terms, rights, restrictions and obligations on using FEATool and
% CFDTool ("Software", "Program(s)") and documentation ("Documentation")
